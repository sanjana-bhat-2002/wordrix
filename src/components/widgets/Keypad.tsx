...
const Keypad = ({ onKeyPress, keyColors }: KeypadProps) => {
  return (
    <div className="text-white m-12 max-w-xl">
      <div className="flex justify-center mb-2">
        {firstRow.map((letter, index) => (
          <Key key={index} color={keyColors[letter]} onClick={() => onKeyPress(letter)}> {letter} </Key>
        ))}
      </div>
      <div className="flex justify-center mb-2">
